...
<!-- 默认皮肤 -->
<link href="<%=path %>/easyui/css/default/easyui.css" rel="stylesheet" type="text/css" id="easyuiTheme"/>
...
<script type="text/javascript">window.onload = function(){var objLoading = document.getElementById("divprogressbar");if (objLoading != null){document.body.removeChild(objLoading);}};</script>
</head>
...
<div id="divprogressbar" style="position: absolute;width: 100%; height: 100%; left: 0px; top: 0px; background-color: #ffffff; filter: alpha (opacity = 100 ); z-index: 50000">  
   <div style="text-align: center;padding-top: 200px">  
      <table align="center" border="1" width="37%" cellspacing="0" cellpadding="4" style="border-collapse: collapse;" bgcolor="#fff" height="87"><!-- #FFFFEC -->  
         <tr>  
            <td bgcolor="#95B8E7" style="font-size: 12px;" height="24" align="center">  
                        友情提示, 数据正在载入中...  
            </td>  
         </tr>  
         <tr>  
...
<div id="logo" data-options="region:'north',split:true" style="height:70px;background-image:url('<%=path%>/resource/images/banner.jpg')">
			...
			<table class="right-div">
				<tbody>
					<tr>
						<td></td>
						<td>
							<span style="font-size: 28px;font-weight: bold;font-family: Arial;color:#fff;float:right;"><%=new SimpleDateFormat("H:mm").format(new Date()) %></span>
						</td>
					</tr>
					<tr>
						<td>
							<a style="display: inline-block;text-decoration: none;width: 25px;height: 25px;" title="首页定义">
								<img src="resource/images/personset.gif" style="border: 0;width: 22px;height: 22px;margin-right: 5px;"/>
							</a>
							<a style="display: inline-block;text-decoration: none;width: 25px;height: 25px;" title="刷新"><img src="resource/images/refresh.gif" style="border: 0;width: 22px;height: 22px;margin-right: 5px;"></a>
							<a style="display: inline-block;text-decoration: none;width: 25px;height: 25px;" title="帮助中心"><img style="border: 0;width: 22px;height: 22px;margin-right: 5px;" src="resource/images/help.gif"></a>
							<a style="display: inline-block;text-decoration: none;width: 25px;height: 25px;" title="注销"><img style="border: 0;width: 22px;height: 22px;margin-right: 5px;" src="resource/images/logout.gif"></a>
						</td>
						<td>
							<span class="curDatetime" style="display: inline-block;font-size: 15px;color: #fff;font-weight: bold;"><%=new SimpleDateFormat("yyyy年MM月dd日 E").format(new Date()) %></span>
						</td>
					</tr>
				</tbody>
			</table>
    ...
    <div id="west-div"  data-options="region:'center'">
    	<div id="_tabs">
			<div title="首页" iconCls="icon-house" style="padding:5px; display:block;">
				<!-- 欢迎来到后台管理系统！ -->
    ...
    <div data-options="region:'west',title:'功能导航',split:true" style="width:200px;"><!-- iconCls="icon-menu" -->
		<div class="easyui-accordion" data-options="border:false,fit:true">   
		    <div title="更换皮肤:<select name='theme' style='width:120px;border-radius: 5px 5px 5px 5px;border: 1px solid #95B8E7;background-color: #fff;margin: 0;padding:0;' onchange='javascript:_change()'>
				<option value='default'>默认</option>   
				<option value='gray'>灰色</option>   
				<option value='metro'>Metro</option>   
				<option value='black'>黑色</option>   
				<option value='bootstrap'>Bootstrap</option>
				<option value='material'>布色</option>   
				</select>" data-options="collapsible:false" id="accordion-one">
			</div>
			<div title="个人" data-options="collapsible:false" id="accordion-two">
				...
				<div class="menu-div">
					<ul>
						<li>
							<a class="active">
								<div>
									<img alt="" src="resource/images/psnStartFlow.png"/>流程发起
								</div>
							</a>
						</li>
						<li>
							<a>
								<div>
									<img alt="" src="easyui/css/icons/myTask_db.png"/>待办流程
									<img src="resource/images/dropIcon1.gif" class="menu_tag" />
								</div>
							</a>
						</li>
						<li>
							<a>
								<div>
									<img alt="" src="resource/images/psnMyApplication.png"/>我的申请
								</div>
							</a>
						</li>
						<li>
							<a>
								<div>
									<img alt="" src="easyui/css/icons/handleTask_db.png"/>待办任务
								</div>
							</a>
						</li>
						<li>
							<a>
								<div>
									<img alt="" src="resource/images/myMagSchedule.png"/>我的日程
								</div>
							</a>
						</li>
						<li>
							<a>
								<div>
									<img alt="" src="resource/images/myGoOut.png"/>我的去向
								</div>
							</a>
						</li>
						<li>
							<a>
								<div>
									<img alt="" src="resource/images/psnMyApplication.png"/>我的考勤
								</div>
							</a>
						</li>
						<li>
							<a>
								<div>
									<img alt="" src="resource/images/imailManage.png"/>我的邮件
								</div>
							</a>
						</li>
						<li>
							<a>
								<div>
									<img alt="" src="resource/images/myLoanList.png"/>我的借款
								</div>
							</a>
						</li>
						<li>
							<a>
								<div>
									<img alt="" src="resource/images/myCertificate.png"/>我的证件
								</div>
							</a>
						</li>
						<li>
							<a>
								<div>
									<img alt="" src="resource/images/myAssets.png"/>我的资产
								</div>
							</a>
						</li>
					</ul>
			...
			<%-- <div title="流程发启" data-options="collapsible:false,onSelect:goChange('5667',1)" style="overflow:auto;">   
		    	<ul class="easyui-tree" id="_tree" data-options="url:'<%= path%>/tree',lines:true"></ul>
			</div>   
			<div title="消息菜单" data-options="collapsible:false">   
			</div>   
			<div title="应用3" data-options="collapsible:false">   
			</div>   --%>
		</div>  
	</div> 
...
for (var i=0,authmenu=<%=request.getAttribute("authmenus") %>;i < authmenu.length;i++) {
	if(authmenu[i].text == "个人"){
		...
		_h +="<span>"+authmenu[i].text+"</span></div></div></a></li>";
	}else{
